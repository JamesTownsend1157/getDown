...
localStorage.setItem("lats", mapdatalat);
 ...
 function concert(){
     ...
     var queryURL = "https://api.jambase.com/events?zipCode=" + zip +"&radius=20page=0&api_key=rxt9sjc2qgka4rnyrneq55j3"
     ...
     $.ajax({
        ...
        var q2 = $("<a class='has-text-info is-size-5-fullhd'>").append("<strong>Buy Tickets Now</strong>" + "<br>");
            q2.attr("href", venURL);
            secondDiv.append(q2);
        var q3 = $("<a class='has-text-danger is-size-5-fullhd'>").append("<strong>Who The **** is This</strong>" + "<br>");
